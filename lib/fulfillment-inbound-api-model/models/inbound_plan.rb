...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class InboundPlan
    ...
    def hash
      [contact_information, created_at, inbound_plan_id, last_updated_at, marketplace_ids, name, packing_options, placement_options, shipments, source_address, status].hash
    end
