...
module AmzSpApi::FulfillmentInboundApiModel
  ...
  class Shipment
    ...
    attr_accessor :pallet_information
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'pallet_information')
        self.pallet_information = attributes[:'pallet_information']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          pallet_information == o.pallet_information &&
    ...
    def hash
      [amazon_reference_id, contact_information, dates, destination, inbound_plan_id, name, pallet_information, placement_option_id, selected_transportation_option_id, self_ship_appointment_details, shipment_confirmation_id, shipment_id, source, status, tracking_details].hash
    end
