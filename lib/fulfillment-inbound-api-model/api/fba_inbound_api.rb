...
module AmzSpApi::FulfillmentInboundApiModel
  class FbaInboundApi
    ...
    def cancel_self_ship_appointment(body, inbound_plan_id, shipment_id, slot_id, opts = {})
      data, _status_code, _headers = cancel_self_ship_appointment_with_http_info(body, inbound_plan_id, shipment_id, slot_id, opts)
      data
    end
    ...
    def cancel_self_ship_appointment_with_http_info(body, inbound_plan_id, shipment_id, slot_id, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && slot_id.nil?
        fail ArgumentError, "Missing the required parameter 'slot_id' when calling FbaInboundApi.cancel_self_ship_appointment"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/selfShipAppointmentSlots/{slotId}/cancellation'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s).sub('{' + 'shipmentId' + '}', shipment_id.to_s).sub('{' + 'slotId' + '}', slot_id.to_s)
    ...
    def list_packing_group_items(inbound_plan_id, packing_option_id, packing_group_id, opts = {})
      data, _status_code, _headers = list_packing_group_items_with_http_info(inbound_plan_id, packing_option_id, packing_group_id, opts)
      data
    end
    ...
    def list_packing_group_items_with_http_info(inbound_plan_id, packing_option_id, packing_group_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'packing_option_id' is set
      if @api_client.config.client_side_validation && packing_option_id.nil?
        fail ArgumentError, "Missing the required parameter 'packing_option_id' when calling FbaInboundApi.list_packing_group_items"
      end
      ...
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions/{packingOptionId}/packingGroups/{packingGroupId}/items'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s).sub('{' + 'packingOptionId' + '}', packing_option_id.to_s).sub('{' + 'packingGroupId' + '}', packing_group_id.to_s)
    ...
    def update_shipment_delivery_window(body, inbound_plan_id, shipment_id, opts = {})
      data, _status_code, _headers = update_shipment_delivery_window_with_http_info(body, inbound_plan_id, shipment_id, opts)
      data
    end
    ...
    # @param shipment_id Identifier to a shipment. A shipment contains the boxes and units being inbounded.
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateShipmentDeliveryWindowResponse, Integer, Hash)>] UpdateShipmentDeliveryWindowResponse data, response status code and response headers
    def update_shipment_delivery_window_with_http_info(body, inbound_plan_id, shipment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FbaInboundApi.update_shipment_delivery_window ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FbaInboundApi.update_shipment_delivery_window"
      end
      # verify the required parameter 'inbound_plan_id' is set
      if @api_client.config.client_side_validation && inbound_plan_id.nil?
        fail ArgumentError, "Missing the required parameter 'inbound_plan_id' when calling FbaInboundApi.update_shipment_delivery_window"
      end
      # verify the required parameter 'shipment_id' is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        fail ArgumentError, "Missing the required parameter 'shipment_id' when calling FbaInboundApi.update_shipment_delivery_window"
      end
      # resource path
      local_var_path = '/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindow'.sub('{' + 'inboundPlanId' + '}', inbound_plan_id.to_s).sub('{' + 'shipmentId' + '}', shipment_id.to_s)
      ...
      return_type = opts[:return_type] || 'UpdateShipmentDeliveryWindowResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FbaInboundApi#update_shipment_delivery_window\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
